...
public class Shader {
	...
	public Shader() {
		this(
			new URL[] {Shader.class.getResource("vertex.glsl")},
			new URL[] {Shader.class.getResource("fragment.glsl")}
		);
	}

	public Shader(URL[] vertexShader, URL[] fragmentShader) {
	...
	public void setWorldMatrix(Matrix4f mat) {
		...
		GL20.glUniformMatrix4fv(worldMatLoc, false, mat.get(new float[16]));
		...
		if ( worldNormalMatLoc > 0 ) {
			...
			GL20.glUniformMatrix3fv(worldNormalMatLoc, false, normalMatrix.get(new float[9]));
		}
